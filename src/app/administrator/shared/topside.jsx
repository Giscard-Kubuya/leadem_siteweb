...
function TopSide() {
  const {base_url} = useContext(AdministratorContext);
  return (
    <nav className="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a className="navbar-brand brand-logo me-5" href="/administrator/dashboard">
          <img src={`${window.location.origin}/logo192.png`} style={{width:'100%'}} className="me-2" alt="logo" />
        </a>
        <a className="navbar-brand brand-logo-mini" href="/administrator/dashboard">
        ...
        <ul className="navbar-nav navbar-nav-right">
          ...
          <li className="nav-item nav-profile dropdown">
            <a
              ...
              id="profileDropdown"
            >
              <img src={`${window.location.origin}/avatar.png`} alt="profile" />
            </a>
            <div
              className="dropdown-menu dropdown-menu-right navbar-dropdown"
